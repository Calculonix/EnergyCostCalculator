...
export const appliancePresets = [
  ...
  { id: 'oven', name: 'Oven', watts: 3200, range: '3,200 W total power from one CATA oven model', description: 'Illustrative rated/active-equivalent power based on a manufacturer-stated 3,200 W total-power oven; thermostat cycling means actual cooking energy can be lower.', sourceStatus: 'illustrative', sourceName: 'CATA Appliances', sourceUrl: 'https://www.cata-appliances.co.uk/cata-700-60cm-72l-pyrolytic-single-oven-stainless-steel', effectiveDate: null, reviewDate: null, sourceNote: 'Source-backed rating for the CATA CAT72PYBK model, not a UK average or measured energy use per cooking session. CATA explains that oven thermostats cycle the heating elements on and off to maintain temperature.' },
  { id: 'fridge-freezer', name: 'Fridge-freezer', watts: 45, range: '45 W average from 150 W rated × 30% duty cycle', description: 'Illustrative average draw: a 150 W rated compressor running about 30% of the time.', sourceStatus: 'illustrative', sourceName: null, sourceUrl: null, effectiveDate: null, reviewDate: null, sourceNote: 'Illustrative preset only; average draw is derived from a 150 W rated load and 30% duty cycle, not a measured figure.' },
